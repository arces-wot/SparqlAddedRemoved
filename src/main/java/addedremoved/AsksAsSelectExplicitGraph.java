...
public class AsksAsSelectExplicitGraph implements IAskAsSelect{
	...
	public AsksAsSelectExplicitGraph(ArrayList<UpdateConstruct> constructsList) {
	...
	private String generateSelectWithExplicitGraph(String graph,String values) {
		return "SELECT ?s ?p ?o { GRAPH <"+graph+"> { ?s ?p ?o }\n VALUES (?s ?p ?o) { \n" + values+ "}}";
	}
	
	private String incapsulateWithExplicitGraph(Bindings bind ) {
		return "(<"+bind.getValue("s")+"><"+bind.getValue("p")+"><"+bind.getValue("o")+">)\n";
	}
