...
public class LumbTestOnly {
	...
	@Test
	public void query1() {
		QueryResponse res=	((QueryResponse)factory.getRequestByName(RequestName.QUERY1.toString()).execute());
	...
	@Test
	public void query2() {	
		QueryResponse res=	((QueryResponse)factory.getRequestByName(RequestName.QUERY2.toString()).execute());
	...
	@Test
	public void query3() {
		QueryResponse res=	((QueryResponse)factory.getRequestByName(RequestName.QUERY3.toString()).execute());
		assertFalse("#)  QUERY N°3",res.isError());
		System.out.println("Query N°3: "+ res.getBindingsResults().size()+ " Triple.");
	}
	@Test
	public void query4() {
		QueryResponse res=	((QueryResponse)factory.getRequestByName(RequestName.QUERY4.toString()).execute());
		assertFalse("#)  QUERY N°4",res.isError());
		System.out.println("Query N°4: "+ res.getBindingsResults().size()+ " Triple.");
	}
	@Test
	public void query5() {
		QueryResponse res=	((QueryResponse)factory.getRequestByName(RequestName.QUERY5.toString()).execute());
		assertFalse("#)  QUERY N°5",res.isError());
		System.out.println("Query N°5: "+ res.getBindingsResults().size()+ " Triple.");
	}
	@Test
	public void query6() {
		QueryResponse res=	((QueryResponse)factory.getRequestByName(RequestName.QUERY6.toString()).execute());
		assertFalse("#)  QUERY N°6",res.isError());
		System.out.println("Query N°6: "+ res.getBindingsResults().size()+ " Triple.");
	}
	@Test
	public void query7() {
		QueryResponse res=	((QueryResponse)factory.getRequestByName(RequestName.QUERY7.toString()).execute());
		assertFalse("#)  QUERY N°7",res.isError());
		System.out.println("Query N°7: "+ res.getBindingsResults().size()+ " Triple.");
	}
	@Test
	public void query8() {
		QueryResponse res=	((QueryResponse)factory.getRequestByName(RequestName.QUERY8.toString()).execute());
		assertFalse("#)  QUERY N°8",res.isError());
		System.out.println("Query N°8: "+ res.getBindingsResults().size()+ " Triple.");
	}
	@Test
	public void query9() {
		QueryResponse res=	((QueryResponse)factory.getRequestByName(RequestName.QUERY9.toString()).execute());
		assertFalse("#)  QUERY N°9",res.isError());
		System.out.println("Query N°9: "+ res.getBindingsResults().size()+ " Triple.");
	}
	@Test
	public void query10() {
		QueryResponse res=	((QueryResponse)factory.getRequestByName(RequestName.QUERY10.toString()).execute());
		assertFalse("#)  QUERY N°10",res.isError());
		System.out.println("Query N°10: "+ res.getBindingsResults().size()+ " Triple.");
	}
	@Test
	public void query11() {
		QueryResponse res=	((QueryResponse)factory.getRequestByName(RequestName.QUERY11.toString()).execute());
		assertFalse("#)  QUERY N°11",res.isError());
		System.out.println("Query N°11: "+ res.getBindingsResults().size()+ " Triple.");
	}
	@Test
	public void query12() {
		QueryResponse res=	((QueryResponse)factory.getRequestByName(RequestName.QUERY12.toString()).execute());
		assertFalse("#)  QUERY N°12",res.isError());
		System.out.println("Query N°12: "+ res.getBindingsResults().size()+ " Triple.");
	}
	@Test
	public void query13() {
		QueryResponse res=	((QueryResponse)factory.getRequestByName(RequestName.QUERY13.toString()).execute());
	...
	@Test
	public void query14() {
		QueryResponse res=	((QueryResponse)factory.getRequestByName(RequestName.QUERY14.toString()).execute());
